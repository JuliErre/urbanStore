                ...
                <Formik
                    ...
                    validate={(valores) => {
                        ...
                        if (!valores.email) {
                            ...
                            errores.email = 'solo puede contener letras y sus respectivos caracteres'
                    ...
                    {({ values, errors, handleSubmit, handleChange, handleBlur }) => (
                        <form className='form' onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <ErrorMessage name="cel" component={() => (<div className="error"> {errors.cel} </div>)} />
                            </div>

                            <button type="submit" className="btnBlack" >Comprar</button>
